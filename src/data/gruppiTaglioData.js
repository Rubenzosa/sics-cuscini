...
// Dati verificati sul PDF Gruppi_da_taglio_SIMDB.pdf
// ═══════════════════════════════════════════════════════════

export const gruppiTaglioData = [
  {
    id: "gt-40-10",
    numero: "14/15", nome: "40/10", mezzo: "VF 16701", tipoMezzo: "40/10",
    dislocazione: "Sede Centrale", annoAcquisto: 2007,
  ...
  {
    id: "gt-aps-actros",
    numero: "18/21", nome: "APS ACTROS", mezzo: "VF 24491", tipoMezzo: "APS ACTROS",
    dislocazione: "Sede Centrale", annoAcquisto: 2006,
    sistema: "oleodinamico", marca: "LUKAS", stato: "attivo",
    componenti: [
      ...
      { tipo:"CENTRALINA AUSILIARIA",   modello:"INTERFRON VP700-I",  matricola:"151",         pressione:"630 BAR", statoComp:"Ottimo", olio:"HLP10", candela:"",           ultimaRevisione:"2024-12-01", prossimaRevisione:"2024-12-01", annoComp:2006 },
  ...
  {
    id: "gt-aps-120",
    numero: "1", nome: "APS 120", mezzo: "VF 29453", tipoMezzo: "APS 120",
    dislocazione: "Sede Centrale", annoAcquisto: 2018,
  ...
  {
    id: "gt-aps-120-20",
    numero: "6", nome: "APS 120/20", mezzo: "VF 31450", tipoMezzo: "APS 120/20",
    dislocazione: "Sede Centrale", annoAcquisto: 2021,
    sistema: "elettrico", marca: "LUKAS", stato: "attivo",
    componenti: [
  ...
  {
    id: "gt-aps-volvo",
    numero: "5", nome: "APS VOLVO", mezzo: "VF 26504", tipoMezzo: "APS VOLVO",
    dislocazione: "Sede Centrale", annoAcquisto: 2021,
    sistema: "elettrico", marca: "LUKAS", stato: "attivo",
    componenti: [
  ...
  {
    id: "gt-aps-100",
    numero: "19", nome: "APS 100", mezzo: "VF 20946", tipoMezzo: "APS 100",
    dislocazione: "Sede Centrale", annoAcquisto: 2015,
  ...
  {
    id: "gt-aps-man",
    numero: "3", nome: "APS MAN", mezzo: "VF 29926", tipoMezzo: "APS MAN",
    dislocazione: "Sede Centrale", annoAcquisto: 2019,
  ...
  },
  {
    ...
    numero: "16", nome: "APS 180 Montepulciano", mezzo: "VF 30217", tipoMezzo: "APS 180",
    dislocazione: "Montepulciano", annoAcquisto: 2018,
    sistema: "oleodinamico", marca: "HOLMATRO", stato: "attivo",
    componenti: [
  ...
  {
    id: "gt-polisoccorso",
    numero: "4", nome: "POLISOCCORSO", mezzo: "VF 29068", tipoMezzo: "POLISOCCORSO",
    dislocazione: "Sede Centrale", annoAcquisto: 2021,
    sistema: "elettrico", marca: "LUKAS", stato: "attivo",
    componenti: [
  ...
  },
  {
    ...
    numero: "20/18", nome: "APS 180 Montalcino", mezzo: "VF 30725", tipoMezzo: "APS 180",
    dislocazione: "Montalcino", annoAcquisto: 2015,
    sistema: "oleodinamico", marca: "HOLMATRO", stato: "attivo",
    componenti: [
  ...
  {
    id: "gt-aps-140-4x4",
    numero: "22/17", nome: "APS 140 4X4", mezzo: "VF 22777", tipoMezzo: "APS 140 4X4",
    dislocazione: "Sede Centrale", annoAcquisto: 2017,
    sistema: "oleodinamico", marca: "HOLMATRO", stato: "attivo",
    componenti: [
  ...
  // ── FUORI SERVIZIO (kit 10) — stato fuori_uso definitivo
  {
    id: "gt-fuori-servizio",
    numero: "10", nome: "Kit 10 — Fuori uso", mezzo: "FUORI SERVIZIO", tipoMezzo: "",
    dislocazione: "Magazzino", annoAcquisto: 1998,
    ...
    componenti: [
      ...
      { tipo:"TUBI 10 MT",              modello:"LUKAS",             matricola:"",               pressione:"630 BAR", statoComp:"Fuori uso", olio:"",      candela:"",           ultimaRevisione:"2017-07-01", prossimaRevisione:"2020-07-01", annoComp:null },
    ]
  },
  // ── MAGAZZINO kit 12 — ZUMBO (350 bar, Kawasaki) — SEPARATO da kit 2
  {
    id: "gt-magazzino-12",
    numero: "12", nome: "Magazzino ZUMBO", mezzo: "MAGAZZINO", tipoMezzo: "",
    dislocazione: "Magazzino", annoAcquisto: 2002,
  ...
  // ── MAGAZZINO kit 2 — RESQTEC (720 bar, elettrico, NO REVISIONE) — SEPARATO da kit 12
  {
    id: "gt-magazzino-2",
    numero: "2", nome: "Magazzino RESQTEC", mezzo: "MAGAZZINO", tipoMezzo: "",
    dislocazione: "Magazzino", annoAcquisto: 2017,
